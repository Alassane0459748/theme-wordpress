...
<div class="dropdown-menu cart-list woocommerce-mini-cart cart_list product_list_widget <?php echo esc_attr($args['list_class']); ?>">
						...
						<div class="thumb">
							...
							echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
								...
								sprintf(
									...
									esc_attr__('Remove this item', 'digalu'),
									esc_attr($product_id),
	...
	<?php else : ?>
		...
		<div class="empty_cart text-center">
			...
			<?php
			echo '<p>' . esc_html__('Your cart is currently empty.', 'digalu') . '</p>'; ?>
		</div>
	...
	<div class="total">
			<span><?php echo esc_html__('Sub Total: ', 'digalu') ?> <strong><?php echo wp_kses_post(WC()->cart->get_cart_subtotal()); ?></strong></span>
