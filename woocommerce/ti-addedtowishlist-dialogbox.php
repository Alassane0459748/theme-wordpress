			...
			<div class="tinv-modal-inner">
				...
				<div class="tinvwl-buttons-group tinv-wishlist-clear">
					<?php if ( isset( $wishlist_url ) ) : ?>
						<button class="button tinvwl_button_view tinvwl-btn-onclick btn btn-md btn-theme"
					...
					<?php endif; ?>
					<button class="button tinvwl_button_close vs-btn" type="button"><i
								class="ftinvwl ftinvwl-times"></i><?php esc_html_e( 'Close', 'digalu' ); ?>
					</button>
				</div>
