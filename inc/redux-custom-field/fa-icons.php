...
// the opt_name is set to digalu_opt.  Please replace it if change your opt_name name.
add_action( 'redux/page/digalu_opt/enqueue', 'digalu_faIconFont' );
function digalu_faIconFont() {
	
  //  Font awesome enqueue
  wp_enqueue_style( 'font-awesome', DIGALU_DIR_CSS_URI.'font-awesome.min.css', array(), '4.7.0', 'all' );
  
  // Redux admin css enqueue
  wp_enqueue_style( 'digalu-redux-admin', DIGALU_DIR_URI.'inc/redux-custom-field/assets/digalu.redux.admin.css', array(), '1.0' );
  
  // Redux admin js enqueue
  wp_enqueue_script( 'digalu-redux-admin', DIGALU_DIR_URI.'inc/redux-custom-field/assets/digalu.redux.admin.js', array( 'jquery' ), '1.0', true );
