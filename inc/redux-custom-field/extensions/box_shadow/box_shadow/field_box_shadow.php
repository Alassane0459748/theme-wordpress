    ...
    class ReduxFramework_box_shadow extends ReduxFramework_extension_box_shadow
    {
        ...
        public function render()
        {
            ...
            if ($this->field['horizontal'] === true) {
                ...
                echo '<label>' . esc_html__('Offset X', 'digalu') . '</label>';
                echo '<span class="add-on"><i class="el el-resize-horizontal icon-large"></i></span>';
                echo '<input type="text" class="redux-shadow-input redux-shadow-horizontal mini ' . $this->field['class'] . '" placeholder="' . esc_html__('X', 'digalu') . '" rel="' . $this->field['id'] . '-horizontal" value="' . filter_var($this->value['horizontal'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION) . '">';
            ...
            if ($this->field['vertical'] === true) {
                ...
                echo '<div class="field-shadow-input input-prepend">';
                echo '<label>' . esc_html__('Offset Y', 'digalu') . '</label>';
                echo '<span class="add-on"><i class="el el-resize-vertical icon-large"></i></span>';
                echo '<input type="text" class="redux-shadow-input redux-shadow-vertical mini ' . $this->field['class'] . '" placeholder="' . __('Y', 'digalu') . '" rel="' . $this->field['id'] . '-vertical" value="' . filter_var($this->value['vertical'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION) . '">';
            ...
            if ($this->field['blur'] === true) {
                ...
                echo '<div class="field-shadow-input input-prepend">';
                echo '<label>' . esc_html__('Blur Radius', 'digalu') . '</label>';
                echo '<span class="add-on"><i class="el el-adjust icon-large"></i></span>';
                echo '<input type="text" class="redux-shadow-input redux-shadow-blur mini ' . $this->field['class'] . '" placeholder="' . esc_html__('Blur', 'digalu') . '" rel="' . $this->field['id'] . '-blur" value="' . filter_var($this->value['blur'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION) . '">';
            ...
            if ($this->field['spread'] === true) {
                ...
                echo '<div class="field-shadow-input input-prepend">';
                echo '<label>' . esc_html__('Spread Radius', 'digalu') . '</label>';
                echo '<span class="add-on"><i class="el el-idea icon-large"></i></span>';
                echo '<input type="text" class="redux-shadow-input redux-shadow-spread mini ' . $this->field['class'] . '" placeholder="' . esc_html__('Spread', 'digalu') . '" rel="' . $this->field['id'] . '-spread" value="' . filter_var($this->value['spread'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION) . '">';
            ...
            if ($this->field['opacity'] === true) {
                ...
                echo '<div class="field-shadow-input input-prepend">';
                echo '<label>' . esc_html__('Opacity .1 - 1', 'digalu') . '</label>';
                echo '<span class="add-on"><i class="el el-idea icon-large"></i></span>';
                echo '<input type="text" class="redux-shadow-input redux-shadow-opacity mini ' . $this->field['class'] . '" placeholder="' . esc_html__('Opacity', 'digalu') . '" rel="' . $this->field['id'] . '-opacity" value="' . filter_var($this->value['opacity'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION) . '">';
            ...
            if (isset($this->field['units']) && $this->field['units'] !== false) {
                echo '<div class="shadow-units" original-title="' . esc_html__('Units', 'digalu') . '">';
                echo '<label>' . esc_html__('Units', 'digalu') . '</label>';
                echo '<select data-id="' . $this->field['id'] . '" data-placeholder="' . esc_html__('Units', 'digalu') . '" class="redux-shadow redux-shadow-units select ' . $this->field['class'] . '" original-title="' . esc_html__('Units', 'digalu') . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[units]' . '">';
            ...
            if ($this->field['shadow-color'] === true) {
                ...
                echo '<div class="shadow-color" original-title="' . esc_html__('Shadow Color', 'digalu') . '">';
                echo '<label>' . esc_html__('Shadow Color', 'digalu') . '</label>';
            ...
            if ($this->field['shadow-type'] === true) {
                ...
                echo '<div class="shadow-type" original-title="' . esc_html__('Shadow Type', 'digalu') . '">';
                echo '<label>' . esc_html__('Shadow Type', 'digalu') . '</label>';
                echo '<select id="' . $this->field['id'] . '-shadow-type-select" data-placeholder="' . esc_html__('Shadow Type', 'digalu') . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[shadow-type]" class="redux-select-item redux-background-input redux-shadow-type ' . $this->field['class'] . '">';
                echo '<option></option>';
            ...
            if ($this->field['preview'] === true) {
                ...
                echo '<div class="clearfix"></div><div class="shadow-previewer" original-title="' . esc_html__('Shadow Preview', 'digalu') . '">';
